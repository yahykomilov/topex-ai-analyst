...
# OpenAI Whisper — всегда как fallback (если ключ есть)
if OPENAI_API_KEY:
    _PROVIDERS.append({
        "name": "OpenAI Whisper",
...
async def transcribe(audio_path: Path) -> str:
    ...
    Цепочка:
      1. Gemini Flash (если uz — основной, у него лучше multilingual)
      2. Groq Whisper #1 (основной, бесплатный)
      3. Groq Whisper #2 (запасной ключ)
      4. OpenAI Whisper (запасной)
    """
